...
<div class="card">
  <div class="card-header">需求单列表</div>
  <div class="card-body">
    <ul class="list-group">
                  ...
                  <tr>
                    ...
                    @if($index === 0)
                      ...
                      <td rowspan="{{ count($order->items) }}" class="text-center">
                        ...
                        @else
                          未确认<br>
                          请于 {{ $order->created_at->addSeconds(config('app.order_ttl'))->format('H:i') }} 前完成确认<br>
                          否则需求单将自动关闭
                        @endif
                      </td>
                      <td rowspan="{{ count($order->items) }}" class="text-center"><a class="btn btn-primary btn-sm" href="">查看需求单</a></td>
                    @endif
                  </tr>
                @endforeach
              </table>
